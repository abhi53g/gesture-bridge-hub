...
const Index = () => {
  return (
    <div className="min-h-screen flex flex-col bg-background">
      <SEO title="SignAI — ASL Translation & Pose Retrieval" description="AI-powered ASL translation with real-time webcam capture, 3D pose viewer, and semantic search." />
      ...
      <main className="flex-1">
          ...
          <div className="container mx-auto relative grid md:grid-cols-2 gap-10 items-center py-16 md:py-24">
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Real-time ASL to text, semantic pose search, and research-grade analytics — in one intuitive interface.
              </p>
            ...
            <div className="relative">
              <img src={heroImg} alt="People using ASL with AI gradient waves" className="rounded-xl border shadow-[var(--shadow-elegant)]" loading="lazy" />
            </div>
          </div>
        </section>
        ...
        <section id="features" className="container mx-auto py-16 md:py-24">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              { icon: Camera, title: 'Live Webcam', desc: 'Capture ASL in real-time with pose overlays.' },
        ...
        <section className="container mx-auto py-16 md:py-24">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {[
              { q: 'The best ASL tool I\'ve tried — fast and accurate.', a: 'Researcher, Gallaudet University' },
